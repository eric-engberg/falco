...
public:
	...
	std::unique_ptr<falco_load_result> load_rules_file(const std::string &rules_filename);
	std::unique_ptr<falco_load_result> load_rules(const std::string &rules_content, const std::string &name);
