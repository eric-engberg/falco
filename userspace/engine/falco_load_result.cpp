...
const std::string& falco_load_result::warning_code_str(warning_code wc)
{
...
const std::string& falco_load_result::warning_str(warning_code wc)
{
...
const std::string& falco_load_result::warning_desc(warning_code wc)
{
